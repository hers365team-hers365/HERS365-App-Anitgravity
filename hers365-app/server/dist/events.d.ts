...
export type DomainEvent = UserCreatedEvent | UserUpdatedEvent | UserDeletedEvent | LoginAttemptedEvent | LoginSuccessfulEvent | LoginFailedEvent | TokenRefreshedEvent | ScholarshipOfferedEvent | ScholarshipAcceptedEvent | MessageSentEvent | PaymentProcessedEvent | NILDealCreatedEvent | AuditEventLoggedEvent | ComplianceViolationEvent | ComplianceViolationDetectedEvent | DataBreachReportedEvent | DataExportRequestedEvent | DataExportCompletedEvent | DataExportFailedEvent | DataDeletionRequestedEvent | DataDeletionCompletedEvent | DataDeletionFailedEvent | ServiceHealthEvent | CircuitBreakerEvent;
